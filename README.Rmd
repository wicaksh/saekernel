...
## Functions
* `saekernel()` Produces Small Area Estimation Non-Parametric based Nadaraya-Watson Kernel
* `mse_saekernel()` Produces Small Area Estimation Non-Parametric based Nadaraya-Watson Kernel and Bootstrap Mean Squared Error
